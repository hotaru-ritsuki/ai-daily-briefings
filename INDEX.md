...
- **[2026-06-16](briefings/2026-06-16.md)**
  ...
  - Anthropic met Trump-admin officials June 15 with no resolution — both sides still split on Fable 5 risk; Axios widens dispute beyond Amazon-jailbreak trigger to alleged CCP-linked Mythos access + cyber-EO non-compliance; original Claude 4 models (`claude-sonnet-4-20250514`, `claude-opus-4-20250514`) retired from API same day with no grace period — sweep CI logs for `model_not_found`; GLM-5.2 weights now actually live on Hugging Face (vs "arriving next week" per launch announcement)
